...
INSERT INTO drugs (name, price) SELECT 'Amoxicillin', 25.99 WHERE NOT EXISTS (SELECT * FROM drugs WHERE name='Amoxicillin');
INSERT INTO drugs (name, price) SELECT 'Carprofen', 45.50 WHERE NOT EXISTS (SELECT * FROM drugs WHERE name='Carprofen');
INSERT INTO drugs (name, price) SELECT 'Metronidazole', 30.00 WHERE NOT EXISTS (SELECT * FROM drugs WHERE name='Metronidazole');
INSERT INTO drugs (name, price) SELECT 'Prednisone', 15.75 WHERE NOT EXISTS (SELECT * FROM drugs WHERE name='Prednisone');
INSERT INTO drugs (name, price) SELECT 'Apoquel', 89.99 WHERE NOT EXISTS (SELECT * FROM drugs WHERE name='Apoquel');
